...
/** 
*
* help_faq [Swedish] (version 0.8.0 - 3.0.RC8)
*
* @package language
* @version $Id: help_faq.php,v 1.16 2007/12/01 15:34:09 virtuality Exp $
...
$help = array(
	...
	array(
		...
		1 => 'Endast registrerade användare kan skicka e-post via det inbygga e-postformuläret till andra använda, och endast om det har aktiverats av administratören. Detta för att förhindra att anonyma användare använder det för att skicka skräppost.'
	),
	array(
		0 => '--',
	...
	array(
		...
		1 => 'Vissa kategorier kan vara begränsade till vissa användare eller grupper. För att visa, läsa, posta, osv. kan du behöva speciell tillåtelse som endast moderatorer och administratörer kan ge dig. Pröva att kontakta de.'
	),
	array(
		0 => 'Varför kan jag inte rösta i omröstningar?',
		1 => 'Endast registrerade användare kan rösta i omröstningar (förhindrar fusk). Om du har registrerat dig och ändå inte kan rösta så har du förmodligen inte de rättigheter som krävs.'
	),
	array(
	...
	array(
		...
		1 => 'Alla administratörer har egna regler för sina webbplatser. Om de anser att du har brutit mot en regel så kan de utfärda en varning mot dig. Observera att detta är administratörens beslut, och att phpBB Group inte har någonting att göra med varningar på andra webbplatser. Kontakta forumadministratören om du är osäker på varför du varnats.'
	),
	array(
		0 => 'Hur kan jag rapportera inlägg till en moderator?',
		1 => 'Om forumadministratören har tillåtit det så ska du se en bild som används för att rapportera inlägg bredvid inlägget som du vill rapportera. Klicka på denna bild och du kommar att guidas igenom stegen som krävs för att rapportera inlägget.'
	),
	array(
	...
	array(
		...
		1 => 'Globala anslag innehåller viktig information och du bör läsa de så fort som möjligt. Globala anslag visas överst på varje sida i varje kategori och i kontrollpanelen. Om du kan posta ett globalt anslag eller inte beror på vilka rättigheter som krävs och dessa ställs in av forumadministratören.'
	),
	array(
		0 => 'Vad är anslag?',
		1 => 'Anslag innehåller ofta viktig information om kategorin du för tillfället läser i och du bör läsa de så fort som möjligt. Anslag visas överst på varje sida i kategorin de postats i. Som med globala anslag så beror det på vilka rättigheter som krävs om du kan posta anslag eller inte och dessa ställs in av forumadministratören.'
	),
	array(
		0 => 'Vad är notiser?',
		1 => 'Notiser visas under eventuella anslag och endast på första sidan i kategorin de postats i. De är ofta rätt viktiga så du bör läsa de när du kan. Som med anslag och globala anslag så är det forumadministratören som bestämmer vilka rättigheter som krävs för att kunna posta notiser.'
	),
	array(
		0 => 'Vad är låsta trådar?',
		1 => 'Låsta trådar är trådar där användare inte kan svara och omröstningar automatiskt avslutats. Trådar kan låsas av många anledningar och de låses av moderatorer eller forumadministratörer. Det är möjligt att du också kan låsa dina egna trådar om du har de rättigheter som krävs.'
	),
	array(
		0 => 'Vad är trådikoner?',
	...
	array(
		...
		1 => 'Användargrupper är grupper av medlemmar som delar in forumets medlemmar i lätthanterliga sektioner som forumadministratörerna kan arbeta med. Varje användar kan vara medlem i flera grupper och kan tilldelas individuella rättigheter. Detta gör det enkelt för administratörer att ändra rättigheter för många användare per samma gång, som till exempel att byta moderationsrättigheter eller ge användare tillgång till ett privat forum.'
	),
	array(
	...
	array(
		...
		1 => 'Du kan använda dessa listor för att organisera medlemmar på forumet. Medlemmar som läggs till i din vänskapslista kommer visas i din kontrollpanel vilket låter dig snabbt och enkelt visa deras onlinestatus och skicka personliga meddelanden till de. Om det stöds i mallen så kan inlägg från dessa användare också framhävas. Om du lägger till en användare till din ovännerlista så kommer alla inlägg de gör att döljas automatiskt.'
	),
	array(
	...
	array(
		...
		1 => 'Denna programvara (i sin oförändrade form) är producerad av, släppt av och copyright <a href="http://www.phpbb.com/">phpBB Group</a>. Den finns tillgänglig under GNU General Public Licence och får distribueras fritt. Se länken för mer information.'
	),
	array(
