...
/** 
*
* help_bbcode [Swedish] (version 0.8.0 - 3.0.RC8)
*
* @package language
* @version $Id: help_bbcode.php,v 1.14 2007/12/01 15:34:09 virtuality Exp $
...
$help = array(
	...
	array(
		0 => 'Vad är BBCode?',
		1 => 'BBCode är en speciell variant av HTML. Huruvida du kan använda BBCode i dina inlägg på forumet eller inte bestäms av administratören. Dessutom kan nu inaktivera BBCode i specifika inlägg via inläggsformuläret BBCode självt liknar HTML, taggar innesluts av hakparanteser [ och ] istället för &lt; och &gt; och det ger större kontroll över vad och hur saker och ting visas. Om det stöds av forumstilen du använder så kan du lägga till BBCode till dina inlägg genom ett klickbart gränssnitt ovanför meddelanderutan i inläggsformuläret. Även med detta gränssnitt kan du finna följande guide användbar.'
	),
	array(
		0 => '--',
		1 => 'Textformatering'
	...
	array(
		...
		1 => 'Om du är detta forums administratör och har de rättighet så kan du lägga till ytterligare BBCodes genom Egna BBcodes-sektionen.'
	)
);
