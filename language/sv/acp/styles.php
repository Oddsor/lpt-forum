...
/** 
*
* acp_styles [Swedish] (version 0.8.0 - 3.0.RC8)
*
* @package language
* @version $Id: styles.php,v 1.14 2007/12/01 15:34:09 virtuality Exp $
...
$lang = array_merge($lang, array(
	...
	'ADD_IMAGESET_EXPLAIN'	=> 'Här kan du skapa ett nytt bildpaket. Beroende på din serverkonfiguration och filrättigheter så kan du ha ytterligare alternativ här. Till exempel kan det vara möjligt att basera detta bildpaket på ett redan existerande. Det kan också gå att ladda upp eller importera (från store-katalogen) ett bildpaketsarkiv. Om du laddar upp eller importerar ett arkiv så kan bildpaketsnamnet frivilligt tas från arkivnamnet (för att göra detta lämna bildpaketsnamn tomt).',
	'ADD_STYLE'				=> 'Skapa stil',
	'ADD_STYLE_EXPLAIN'		=> 'Här kan du skapa en ny stil. Beroende på din serverkonfiguration och filrättigheter så kan du ha ytterligare alternativ här. Till exempel kan det gå att basera denna stil på en redan existerande. Det kan också gå att ladda upp eller importera (från store-katalogen) ett stilarkiv. Om du laddar upp eller importerar ett arkiv så kommer stilnamnet att avgöras automatiskt.',
	'ADD_TEMPLATE'			=> 'Skapa mall',
	'ADD_TEMPLATE_EXPLAIN'	=> 'Här kan du lägga till en ny mall. Beroende på din serverkonfiguration och filrättigheter så kan du ha ytterligare alternativ här. Till exempel kan det gå att basera denna malluppsättning på en redan existerande. Det kan också gå att ladda upp eller importera (från store-katalogen) att mallarkiv. Om du laddar upp eller importerar ett arkiv så kan mallnamnet frivilligt tas från arkivnamnet (för att göra detta lämna mallnamnet tomt).',
	'ADD_THEME'				=> 'Skapa tema',
	'ADD_THEME_EXPLAIN'		=> 'Här kan du lägga till ett nytt tema. Beroende på din serverkonfiguration och filrättigheter så kan du ha ytterligare alternativ här. Till exempel kan det gå att basera detta tema på ett redan existerande. Det kan också gå att ladda upp eller importera (från store-katalogen) att temaarkiv. Om du laddar upp eller importerar ett arkiv så kan temanamnet frivilligt tas från arkivnamnet (för att göra detta lämna temanamnet tomt).',
	...
	'DELETE_IMAGESET_EXPLAIN'	=> 'Här kan du ta bort det valda bildpaketet från databasen. Du kan också ta bort det från filsystemet om du vill och har de rättigheter som krävs. Kom ihåg att det inte går att ångra. När bildpaketet har raderats är det borta för alltid. Det är rekommenderat att du först exporterar ditt bildpaket för möjlig framtida användning.',
	...
	'DELETE_TEMPLATE_EXPLAIN'	=> 'Här kan du ta bort den valda malluppsättningen från databasen. Du kan också ta bort den från filsystemet om du vill och har de rättigheter som krävs. Kom ihåg att det inte går att ångra. När mallarna raderats är de borta för alltid. Det är rekommenderat att du först exporterar din malluppsättning för möjlig framtida användning.',
	'DELETE_THEME'				=> 'Ta bort tema',
	'DELETE_THEME_EXPLAIN'		=> 'Här kan du ta bort det valda temat från databasen. Du kan också ta bort det från filsystemet om du vill och har de rättigheter som krävs. Kom ihåg att det inte går att ångra. När temat raderats är det borta för alltid. Det är rekommenderat att du först exporterar ditt tema för möjlig framtida användning.',
	'DETAILS'					=> 'Detaljer',
	...
	'IMG_ICON_FOE'			=> 'Lägg till som ovän',
	...
	'IMG_FORUM_UNREAD'			=> 'Kategori nya inlägg',
	'IMG_FORUM_UNREAD_LOCKED'	=> 'Kategori nya inlägg låst',
	'IMG_FORUM_UNREAD_SUBFORUM'	=> 'Underkategori nya inlägg',
 	'IMG_SUBFORUM_READ'			=> 'Legend underkategori',
 	'IMG_SUBFORUM_UNREAD'		=> 'Legend underkategori nya inlägg',
	...
	'IMG_TOPIC_UNREAD'				=> 'Tråd nya inlägg',
	'IMG_TOPIC_UNREAD_MINE'			=> 'Tråd postad i nya',
	'IMG_TOPIC_UNREAD_HOT'			=> 'Tråd populär nya inlägg',
	'IMG_TOPIC_UNREAD_HOT_MINE'		=> 'Tråd populär postad i nya',
	'IMG_TOPIC_UNREAD_LOCKED'		=> 'Tråd låst nya',
	'IMG_TOPIC_UNREAD_LOCKED_MINE'	=> 'Tråd låst postad i nya',
	...
	'IMG_STICKY_UNREAD'				=> 'Notis nya inlägg',
	'IMG_STICKY_UNREAD_MINE'		=> 'Notis postad i nya',
	'IMG_STICKY_UNREAD_LOCKED'		=> 'Notis låst nya inlägg',
	'IMG_STICKY_UNREAD_LOCKED_MINE'	=> 'Notis låst postad i nya',
	...
	'IMG_ANNOUNCE_UNREAD'				=> 'Anslag nya inlägg',
	'IMG_ANNOUNCE_UNREAD_MINE'			=> 'Anslag postat i nya',
	'IMG_ANNOUNCE_UNREAD_LOCKED'		=> 'Anslag låst nya inlägg',
	'IMG_ANNOUNCE_UNREAD_LOCKED_MINE'	=> 'Anslag låst postat i nya',
	...
	'IMG_GLOBAL_UNREAD'					=> 'Globalt nya inlägg',
	'IMG_GLOBAL_UNREAD_MINE'			=> 'Globalt postats i nya',
	'IMG_GLOBAL_UNREAD_LOCKED'			=> 'Globalt låst nya inlägg',
	'IMG_GLOBAL_UNREAD_LOCKED_MINE'		=> 'Globalt låst postats i nya',
	...
	'TEMPLATE_LOCATION_EXPLAIN'	=> 'Bilder lagras alltid på filsystemet.',
	...
	'THEME_ERR_REFRESH_FS'		=> 'Detta tema är lagrat på filsystemet så det behöver inte uppdateras.',
