...
/** 
*
* acp common [Swedish] (version 0.8.0 - 3.0.RC8)
*
* @package language
* @version $Id: common.php,v 1.15 2007/12/01 15:34:08 virtuality Exp $
...
$lang = array_merge($lang, array(
	...
	'ACP_CAT_PERMISSIONS'		=> 'Rättigheter',
	...
	'ACP_GLOBAL_PERMISSIONS'		=> 'Globala rättigheter',
	'ACP_GROUPS'					=> 'Grupper',
	'ACP_GROUPS_FORUM_PERMISSIONS'	=> 'Gruppers kategorirättigheter',
	'ACP_GROUPS_MANAGE'				=> 'Hantera grupper',
	'ACP_GROUPS_MANAGEMENT'			=> 'Grupphantering',
	'ACP_GROUPS_PERMISSIONS'		=> 'Grupprättigheter',
	...
	'ACP_PERMISSIONS'			=> 'Rättigheter',
	'ACP_PERMISSION_MASKS'		=> 'Rättighetsgranskning',
	'ACP_PERMISSION_ROLES'		=> 'Rättighetsroller',
	'ACP_PERMISSION_TRACE'		=> 'Spåra rättigheter',
	...
	'ACP_USERS_FORUM_PERMISSIONS'	=> 'Användares kategorirättigheter',
	'ACP_USERS_LOGS'				=> 'Användarloggar',
	'ACP_USERS_PERMISSIONS'			=> 'Användarrättigheter',
	...
	'ACP_VC_SETTINGS'					=> 'Inställningar för visuell bekräftelse',
	'ACP_VC_CAPTCHA_DISPLAY'			=> 'CAPTCHA bildförhandsvisning',
	'ACP_VERSION_CHECK'					=> 'Kolla efter uppdateringar',
	'ACP_VIEW_ADMIN_PERMISSIONS'		=> 'Visa administrativa rättigheter',
	'ACP_VIEW_FORUM_MOD_PERMISSIONS'	=> 'Visa kategorimoderationssrättigheter',
	'ACP_VIEW_FORUM_PERMISSIONS'		=> 'Visa kategoribaserade rättigheter',
	'ACP_VIEW_GLOBAL_MOD_PERMISSIONS'	=> 'Visa globala moderationsrättigheter',
	'ACP_VIEW_USER_PERMISSIONS'			=> 'Visa användarbaserade rättigheter',
	...
	'GLOBAL_MASK'			=> 'Granska globala rättigheter',
	...
	'LOOK_UP_FORUMS_EXPLAIN'=> 'Du kan välja fler än en kategori.',
	...
	'PERMISSIONS_TRANSFERRED'			=> 'Rättigheterna överfördes',
	'PERMISSIONS_TRANSFERRED_EXPLAIN'	=> 'Du använder nu rättigheterna från %1$s. Du kan använda forumet med användarens rättigheter med du kan inte komma åt administrationspanelen eftersom administratörsrättigheter inte överfördes. Du kan <a href="%2$s"><strong>återgå till dina egna rättigheter</strong></a> när som helst.',
	'PIXEL'							=> 'px',	
...
// Logs
$lang = array_merge($lang, array(
	'ACP_ADMIN_LOGS_EXPLAIN'	=> 'Detta listar alla handlingar som utförts av forumadministratörer. Du kan sortera efter användarnamn, datum, IP eller handling. Om du har de rättigheter som krävs så kan du också rensa ut individuella handlingar eller hela loggen.',
	'ACP_CRITICAL_LOGS_EXPLAIN'	=> 'Detta listar handlingar som forumet själv har utfört. Denna logg ger dig information som du kan använda för att lösa specifika problem, till exempel att e-post inte levereras. Du kan sortera efter användarnamn, datum, IP eller handling. Om du har de rättigheter som krävs så kan du också rensa ut individuella handlingar eller hela loggen.',
...
$lang = array_merge($lang, array(
	...
	'ADMIN_LOG_INDEX_EXPLAIN'	=> 'Detta ger en översikt över de fem senaste handlingarna utförda av forumadministratörer. En full kopia loggan kan nås från menyn eller genom att följa länken nedan.',
	...
	'RESET_DATE'					=> 'Återställ forumets startdatum',
	'RESET_DATE_CONFIRM'			=> 'Är du säker på att du vill återställa forumets startdatum?',
	...
	'RESYNC_POST_MARKING_EXPLAIN'	=> 'Avmärker först alla trådar och märker sedan om alla trådar som varit aktiva under de senaste sex månaderna.',
...
// Log Entries
$lang = array_merge($lang, array(
	'LOG_ACL_ADD_USER_GLOBAL_U_'		=> '<strong>Lade till eller ändrade användarens användarrättigheter</strong><br />» %s',
	'LOG_ACL_ADD_GROUP_GLOBAL_U_'		=> '<strong>Lade till eller ändrade gruppers användarrättigheter</strong><br />» %s',
	'LOG_ACL_ADD_USER_GLOBAL_M_'		=> '<strong>Lade till eller ändrade användares globala moderationsrättigheter</strong><br />» %s',
	'LOG_ACL_ADD_GROUP_GLOBAL_M_'		=> '<strong>Lade till eller ändrade gruppers globala moderationsrättigheter</strong><br />» %s',
	'LOG_ACL_ADD_USER_GLOBAL_A_'		=> '<strong>Lade till eller ändrade användares administratörsrättigheter</strong><br />» %s',
	'LOG_ACL_ADD_GROUP_GLOBAL_A_'		=> '<strong>Lade till eller ändrade gruppers administratörsrättigheter</strong><br />» %s',
	...
	'LOG_ACL_ADD_FORUM_LOCAL_F_'		=> '<strong>Lade till eller ändrade kategorirättigheter</strong> för %1$s<br />» %2$s',
	...
	'LOG_ACL_DEL_FORUM_LOCAL_F_'		=> '<strong>Tog bort användar/gruppkategorirättigheter</strong> from %1$s<br />» %2$s',

	'LOG_ACL_TRANSFER_PERMISSIONS'		=> '<strong>Rättigheter överförda från</strong><br />» %s',
	'LOG_ACL_RESTORE_PERMISSIONS'		=> '<strong>Egna rättigheter återställda efter att ha använt rättigheterna från</strong><br />» %s',
	...
	'LOG_DELETE_TOPIC'			=> '<strong>Tog bort tråd</strong><br />» %s',
	...
	'LOG_MOVE'					=> '<strong>Flyttade tråd</strong><br />» från %s',
	...
	'LOG_TOPIC_DELETED'			=> '<strong>Tog bort tråd</strong><br />» %s',
	...
	'LOG_FORUM_DEL_MOVE_POSTS_FORUMS'		=> '<strong>Tog bort kategori och underkategorier, flyttade meddelanden</strong> till %1$s<br />» %2$s',
	...
	'LOG_FORUM_DEL_POSTS'					=> '<strong>Tog bort kategori och meddelanden</strong><br />» %s',
	'LOG_FORUM_DEL_POSTS_FORUMS'			=> '<strong>Tog bort kategori, meddelanden och underkategorier</strong><br />» %s',
	'LOG_FORUM_DEL_POSTS_MOVE_FORUMS'		=> '<strong>Tog bort kategori och meddelanden, flyttade underkategorier</strong> till %1$s<br />» %2$s',
