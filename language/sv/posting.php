...
/** 
*
* posting [Swedish] (version 0.8.0 - 3.0.RC8)
*
* @package language
* @version $Id: posting.php,v 1.17 2007/12/01 15:34:09 virtuality Exp $
...
$lang = array_merge($lang, array(
	...
	'MAX_FLASH_HEIGHT_EXCEEDED'	=> 'Dina Flashfiler får inte vara högre än %1$d pixlar.',
	'MAX_FLASH_WIDTH_EXCEEDED'	=> 'Dina Flashfiler får inte vara bredare än %1$d pixlar.',
	'MAX_IMG_HEIGHT_EXCEEDED'	=> 'Dina bilder får inte vara högre än %1$d pixlar.',
	'MAX_IMG_WIDTH_EXCEEDED'	=> 'Dina bilder får inte vara bredare än %1$d pixlar.',

	'MESSAGE_BODY_EXPLAIN'		=> 'Skriv ditt meddelande här, det får inte bestå av fler än <strong>%d</strong> tecken.',
	...
	'PHP_SIZE_OVERRUN'			=> 'Bilagan är för stor, maximalstorleken är %d MB.<br />Detta har definierats i php.ini och kan inte överskridas.',
	...
	'POLL_OPTIONS_EXPLAIN'		=> 'Placera varje alternativ på en ny rad. Du kan ange upp till <strong>%d</strong> alternativ.',
	'POLL_OPTIONS_EDIT_EXPLAIN'	=> 'Placera varje alternativ på en ny rad. Du kan ange upp till <strong>%d</strong> alternaitv. Om du tar bort eller lägger till alternativ så kommer alla nuvarande röster återställas.',
	...
	'STICK_TOPIC_FOR_EXPLAIN'	=> 'Ange 0 eller lämna tomt för att skapa en permanent notis/anslag.',
	'STYLES_TIP'				=> 'Tips: Om du först markerar ett textstycke kan du sedan snabbt tillämpa olika stilar på textstycket genom att sedan klicka på den BBCode du vill använda.',
