...
$lang = array_merge($lang, array(
	...
	'BOARD_NOT_INSTALLED_EXPLAIN'	=> 'For å utføre en konvertering, må du allerede ha en stanardinstallasjon av phpBB 3. Merk deg at for en konvertering må den nye og den gamle installasjonen bruke den samme databasen. Du kan nå <a href="%s">utføre en installasjon</a>.',
	'CATEGORY'	=> 'Kategori',
	...
	'CONTINUE_CONVERT_BODY'	=> 'Et tidligere konvertieringsforsøk har blitt foretatt. Du kan nå velge mellom å starte en ny konvertering eller fortsette denne.',
	...
	'DL_CONFIG_EXPLAIN'	=> 'Du kan laste ned config.php til din engen datamaskin. Så må du laste den opp manuelt og erstatte den eksisterende config.php i din phpBB 3.0.-mappe. Husk å laste opp filen i ASCII-format (se FTP-dokumentasjonen din hvis du ikke vet hvordan man gjør dette). Klikk på OK når du er ferdig for å gå videre til neste steg.',
