* WoWMoonclaw - World of Warcraft phpBB theme created by Moonclaw/Mäevah (http://www.wowcr.net/) - Code modifications
* -------------------------------------------------------------------------------------------------------------------
*

These files keep traces of every modification made from phpBB subSilver2 template to WoWMoonclaw.
...
(To keep the names more simple, "subSilver2" is considered as "WoWMoonclaw 3.0.00". And the phpBB version on which the modification is based is indicated in the end of the file name.)
